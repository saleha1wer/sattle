...
from .models import SatelliteImage, Guess, WebsiteStats,Feedback
...
def submit_guess(request):
    if request.method == 'POST':
        ...
        if correct:
            ...
            stats.save()
            response = JsonResponse({"correct": True, "message": "Correct!", "score": request.session['score'], "new_image_url": new_image.image.url, "new_image_id": new_image.id})
        else:
